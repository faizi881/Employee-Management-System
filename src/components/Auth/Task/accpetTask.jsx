  ...
  return (
    <>
      {items.map(({ task, index }) => (
        <div key={index} className="h-full flex-shrink-0 w-[340px] rounded-2xl bg-[#111827] border border-gray-700 p-6 shadow-sm transition-transform hover:-translate-y-0.5 hover:ring-1 hover:ring-pink-400/30">
          <div className="flex justify-between items-center">
            <span className="text-xs uppercase tracking-wide text-gray-300 bg-pink-500/20 border border-pink-500/30 px-2 py-0.5 rounded-md">{task.category || "General"}</span>
